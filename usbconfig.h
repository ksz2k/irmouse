 ...
 * License: Proprietary, free under certain conditions. See Documentation.
 * This Revision: $Id: usbconfig.h 143 2007-02-27 19:02:57Z ksz $
 */
...
//#define  USB_CFG_DEVICE_ID       0x3e, 0xc0	// my Logitech mouse
 ...
 * Use this VID/PID pair ONLY if you understand the implications!
 */
//#define USB_CFG_DEVICE_VERSION  0x30, 0x00
/* Version number of the device: Minor number first, then major number.
 * Krzysiek:: I've defined it in Makefile for easy change..
 */
#define USB_CFG_VENDOR_NAME     'K', 'S', 'z', 'c', 'z', 'u', 'k', 'a'
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     'I', 'R', 'M', 'o', 'u', 's', 'e'
